...
namespace Misuzilla.Applications.AppleWirelessKeyboardHelper
{
    internal static class Win32
    {
        ...
        public static HookProc HookProcedure;

        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        public static extern UInt32 SendInput(UInt32 nInputs, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStruct)]INPUT[] pInputs, Int32 cbSize);

        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        public static extern HookHandle SetWindowsHookEx(int idHook, HookProc lpfn, IntPtr hInstance, int threadId);
        ...
        public struct KeyboardHookEventStruct
        {
            ...
            {
                return String.Format("wVk:{0}, wScan:{1}, dwFlags:{2}, dwExtraInfo(Ptr):{3}", wVk, wScan, dwFlags, dwExtraInfo);
            }
        }
